    ...
    */
    ...
    _renderItem({ item, index }) {
        return (
            ...
            >
                <Text style={styles.text1}>Montant : <Text style={styles.textResult}>{item.amount}</Text></Text>
                ...
                */ }
                <View style={{ backgroundColor: 'white', height: 1, width: 260, alignSelf: 'center', marginTop: 12, marginBottom: 12}}></View>
                {
