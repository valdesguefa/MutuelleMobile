	...
	_renderItem({ item, index }) {
		return (
			...
			>
				...
				<View>
					<Text style={styles.text}>Pseudo: {item.username}</Text>
					<Text style={styles.text}>Sexe: {item.sex} (M:homme, F:femme)</Text>
					<Text
						style={styles.text}
						onPress={() => {
					...
					>
						Email: <Text style={{ color: "gray" }}>{item.email}</Text>
					</Text>
					<Text
						style={styles.text}
						onPress={() => {
					...
					>
						Telephone:<Text style={{ color: "gray" }}> {item.tel} </Text>
					</Text>
					<Text style={styles.text}>Adresse: {item.address}</Text>
					<Text style={styles.text}>Cree le: {item.create_at}</Text>
				</View>
			</View>
		);
	}
