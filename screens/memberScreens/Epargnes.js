						...
						return (
							...
							>
								<Surface style={styles.surface}>
									<View>
										<Text style={{ fontFamily: "poppinsBold", fontSize: 17, color: "#0f4566" }}>
									...
									<View>
										<Text style={{ fontSize: 16, marginBottom: -5, marginLeft: 15, fontFamily: "poppinsMedium" }}>
											Administrateur :
											<Text style={{ fontFamily: "poppinsLight", fontSize: 16 }}> {item.administrator} </Text>
										</Text>
										<Text style={{ fontSize: 16, marginBottom: -5, marginLeft: 15, fontFamily: "poppinsMedium" }}>
											Montant :<Text style={{ fontFamily: "poppinsLight", fontSize: 16 }}> {item.amount} XAF</Text>
										</Text>
									</View>
								</Surface>
							</Animated.View>
